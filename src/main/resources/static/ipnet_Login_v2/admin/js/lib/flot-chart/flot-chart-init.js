...
(function($){
    ...
    var SufeeAdmin = {
        ...
        cpuLoad: function(){
            ...
            var updateInterval = 300;  /* 30 */
            $( "#updateInterval" ).val( updateInterval ).change( function () {
                var v = $( this ).val();
                if ( v && !isNaN( +v ) ) {
                    updateInterval = +v;
                    if ( updateInterval < 1 ) {
                        updateInterval = 2000;  /* 1 */
            ...
            function update() {
                ...
                if(data[29] == 0 || data[29] == 100){
                    document.getElementById("numberOfRealChart").innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + data[29] + "<br />";
                }
                else{
                    document.getElementById("numberOfRealChart").innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + (data[29] + "").toString().substring(0, 9) + "<br />";
                }
